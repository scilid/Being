...
> The first operational prototype of a protocol-driven computational organism.
...
- [GENESIS.md](GENESIS.md) — 从原始汤到有机体的演化计划
...
- 第一个真核 Skill：`skill-genesis`
- 第一个运行闭环：`skill-genesis -> membrane-weaver -> life-created -> metabolic-tracker`
